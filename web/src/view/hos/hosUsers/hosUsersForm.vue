    ...
    <div class="gva-form-box">
      ...
      >
        ...
        <el-form-item label="微信uuid:" prop="wxUuid">
          <el-input
            v-model="formData.wxUuid"
            :clearable="true"
            placeholder="请输入微信uuid"
          />
        </el-form-item>
        ...
        <el-form-item label="女性初潮日期:" prop="womanPeriodDate">
          <el-input
            v-model="formData.womanPeriodDate"
            :clearable="true"
            placeholder="请输入女性初潮日期"
          />
        </el-form-item>
        ...
        <el-form-item label="第一次登记医院:" prop="registerHos">
          <el-select
            v-model="formData.registerHos"
            placeholder="请选择第一次登记医院"
            style="width: 100%"
            :clearable="true"
          >
            <el-option
              v-for="(item, key) in dataSource.registerHos"
              :key="key"
              :label="item.label"
              :value="item.value"
            />
        ...
        <el-form-item label="近一次登记医院:" prop="latelyHos">
          <el-select
            v-model="formData.latelyHos"
            placeholder="请选择近一次登记医院"
            style="width: 100%"
            :clearable="true"
          >
            <el-option
              v-for="(item, key) in dataSource.latelyHos"
              :key="key"
              :label="item.label"
              :value="item.value"
            />
