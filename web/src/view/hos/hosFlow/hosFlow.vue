  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="量表录入id" prop="scaleId" width="120">
          <template #default="scope">
          {{ filterDataSource(dataSource.scaleId,scope.row.scaleId) }}
         </template>
         </el-table-column>
        <el-table-column align="left" label="现场关联id" prop="askId" width="120">
          <template #default="scope">
          {{ filterDataSource(dataSource.askId,scope.row.askId) }}
         </template>
         </el-table-column>
        <el-table-column align="left" label="运动建议id" prop="adviceId" width="120">
          <template #default="scope">
          {{ filterDataSource(dataSource.adviceId,scope.row.adviceId) }}
         </template>
         </el-table-column>
