...
type SysDept struct {
	global.GVA_MODEL
	Name      string `json:"name" form:"name" gorm:"column:name;comment:部门名称;size:191;" binding:"required"` //部门名称
	...
	ParentId  *int   `json:"parentId" form:"parentId" gorm:"column:parent_id;comment:上级部门;size:19;"`        //上级部门
