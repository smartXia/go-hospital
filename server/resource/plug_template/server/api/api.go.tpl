...
import (
	"devops-manage/server/global"
	"devops-manage/server/model/common/response"
{{ if .NeedModel }}	"devops-manage/server/plugin/{{ .Snake}}/model" {{ end }}
	"devops-manage/server/plugin/{{ .Snake}}/service"
