...
import (
	gvaGlobal "devops-manage/server/global"
	"devops-manage/server/model/system"
	"devops-manage/server/plugin/plugin-tool/utils"
{{- if .HasGlobal }}
	"devops-manage/server/plugin/{{ .Snake}}/global"
{{- end }}
	"devops-manage/server/plugin/{{ .Snake}}/router"
