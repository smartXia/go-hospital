...
// @Param data body model.HosFlow true "创建会诊流程"
...
// @accept application/json
// @Produce application/json
// @Param data body model.HosFlow true "删除会诊流程"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除会诊流程"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /hosFlow/deleteHosFlow [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.HosFlow true "更新会诊流程"
...
// @accept application/json
// @Produce application/json
// @Param data query model.HosFlow true "用id查询会诊流程"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取会诊流程列表"
