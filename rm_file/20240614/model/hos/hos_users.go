...
//func (u *HosUsers) BeforeCreate(tx *gorm.DB) (err error) {
//	uid := utils.GetUserID(u.Ctx)
//	u.CreatedBy = &uid
//	return
//}
//
//func (u *HosUsers) BeforeDelete(tx *gorm.DB) (err error) {
//	uid := utils.GetUserID(u.Ctx)
//	tx.Statement.SetColumn("updated_by", uid)
//	return
//}
//func (u *HosUsers) BeforeUpdate(tx *gorm.DB) (err error) {
//	uid := utils.GetUserID(u.Ctx)
//	tx.Statement.SetColumn("updated_by", uid)
//	return
//}
